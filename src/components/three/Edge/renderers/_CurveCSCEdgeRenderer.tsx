// CurveCSCEdgeRenderer.tsx - 단순히 점들을 받아서 곡선으로 렌더링
...
interface CurveCSCEdgeRendererProps {
...
export const CurveCSCEdgeRenderer: React.FC<CurveCSCEdgeRendererProps> = ({
  renderingPoints = [],
  color = "#ff0000",
  opacity = 1,
  width = 0.5,
  ...
  useEffect(() => {
    ...
    group.visible = true;
    console.log(`CSC 렌더링 완료: ${segmentRefs.current.length}개 세그먼트`);
