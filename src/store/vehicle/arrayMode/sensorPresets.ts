...
export const SENSOR_PRESETS: SensorPreset[] = [
  ...
  // 1: 좌커브
  {
    ...
    leftAngle: 15, rightAngle: -20, leftLength: 2.0, rightLength: 1.2,
  },
  // 2: 우커브
  {
    zones: {
      approach: { leftAngle: 20, rightAngle: -15, leftLength: 1.2, rightLength: 2.0, dec: -1 },
      brake:    { leftAngle: 20, rightAngle: -15, leftLength: 0.7, rightLength: 1.2, dec: -3 },
      stop:     { leftAngle: 20, rightAngle: -15, leftLength: 0.4, rightLength: 0.4, dec: -Infinity },
    },
    leftAngle: 20, rightAngle: -15, leftLength: 1.2, rightLength: 2.0,
  },
  // 3: 합류
  {
    zones: {
